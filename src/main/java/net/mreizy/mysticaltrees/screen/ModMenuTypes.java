package net.mreizy.mysticaltrees.screen;
...
import net.mreizy.mysticaltrees.screen.custom.SidePedestalMenu;
...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, MysticalTrees.MOD_ID);
