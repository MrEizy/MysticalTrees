    ...
    public @Nullable BlockState getToolModifiedState(BlockState state, UseOnContext context,
        ...
        if (context.getItemInHand().getItem() instanceof AxeItem) {
            if (STRIPPABLES.isEmpty()) {
                ...
                STRIPPABLES.put(ModBlocks.LAVA_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG);
                STRIPPABLES.put(ModBlocks.LAVA_OAK_WOOD.get(), Blocks.STRIPPED_OAK_WOOD);
                STRIPPABLES.put(ModBlocks.WATER_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG);
                STRIPPABLES.put(ModBlocks.WATER_OAK_WOOD.get(), Blocks.STRIPPED_OAK_WOOD);
                STRIPPABLES.put(ModBlocks.ICE_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG);
                STRIPPABLES.put(ModBlocks.ICE_OAK_WOOD.get(), Blocks.STRIPPED_OAK_WOOD);
                STRIPPABLES.put(ModBlocks.HONEY_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG);
                STRIPPABLES.put(ModBlocks.HONEY_OAK_WOOD.get(), Blocks.STRIPPED_OAK_WOOD);
                STRIPPABLES.put(ModBlocks.DYE_OAK_LOG.get(), Blocks.STRIPPED_OAK_LOG);
                STRIPPABLES.put(ModBlocks.DYE_OAK_WOOD.get(), Blocks.STRIPPED_OAK_WOOD);
